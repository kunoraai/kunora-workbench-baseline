...
for (const c of ['7e031eb', 'faeab2f', 'cadb8e0', 'ceb64b5']) {
  ok(`commit[${c}]`, html.includes(c), 'missing commit reference');
}
for (const t of ['BLOCKED-EXTERNAL', 'declared=66', 'executed=4', 'route_probe=13/13', '未通过独立验收', '有条件通过', 'generation 1', 'STOPPED']) {
