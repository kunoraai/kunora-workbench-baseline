#!/usr/bin/env node
// M2 独立验收评审（m2-accept-r3）机械验收器。
// 用法：node tools/check-m2-accept-r3.mjs --baseline <40hex>
...
const REPORT = 'docs/milestones/m2/reviews/acceptance-r3.md';
const failures = [];
...
for (const ev of ['bin.js', 'LockFileEx', 'flock', 'graceful', 'STOPPED', 'STOPPING', 'BLOCKED-EXTERNAL', 'executed=', '10 paths', '42 schemas']) {
